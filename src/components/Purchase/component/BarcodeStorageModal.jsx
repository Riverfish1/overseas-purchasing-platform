  ...
  render() {
    ...
    const columnsStorageList = [
      ...
      { title: '数量',
        ...
        width: 60,
        render(t, r) {
          return <InputNumber min={0} step="1" placeholder="请输入" value={t > 0 ? t : 1} onChange={p.inputChange.bind(p, 'quantity', r.skuId)} />;
        },
      },
      { title: '在途数量',
        ...
        <Form>
          ...
          <Row>
            <Col>
              ...
              <Table columns={columnsStorageList} bordered scroll={{ x: '130%', y: 500 }} dataSource={storageList} rowKey={r => r.id} pagination={false} />
            </Col>
          </Row>
        </Form>
      </Modal>
